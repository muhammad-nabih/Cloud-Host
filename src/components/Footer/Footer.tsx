...
export default function Footer() {
  return (
    <footer className="bg-[#192949] text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-4">CLOUD HOSTING</h3>
            <p className="text-sm">Reliable cloud hosting solutions for your business needs.</p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm">Email: support@cloudhosting.com</p>
