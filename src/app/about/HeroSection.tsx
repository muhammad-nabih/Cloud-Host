...
const HeroSection = () => (
	<Section className='bg-gradient-to-r from-blue-400 to-blue-950 text-white'>
		<div className='container mx-auto text-center'>
			<motion.h1 className='mb-6 text-5xl font-bold' initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
				About CloudHosting
			</motion.h1>
			<motion.p className='mx-auto max-w-2xl text-xl' initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.4 }}>
