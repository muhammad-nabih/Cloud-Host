			...
			<CardContent>
				<div className='grid w-full items-center gap-4'>
					<div className='flex flex-col space-y-1.5'>
						...
						<Input id='email' type='email' name='email' placeholder='Enter your email' value={email} onChange={handleEmailAndPasswordChange} className='border-[#5d9ff2] text-white' />
					</div>
					<div className='flex flex-col space-y-1.5'>
						...
						<Input
							...
							className='border-[#5d9ff2]text-white'
						/>
					</div>
				</div>
			</CardContent>
